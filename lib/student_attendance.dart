    ...
    if (response.statusCode == 200) {
      ...
      if (data is List) {
        ...
        setState(() {
          ...
          isContainerVisible = List.generate
          (roll.length, (index) => false);
          isPresentButtonSelected =
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildYearButton('1st Sem', '1st'),
                _buildYearButton('2nd Sem', '2nd'),
                _buildYearButton('3rd Sem', '3rd'),

                _buildYearButton('4th Sem', '4th'),
                _buildYearButton('5th Sem', '5th'),
                _buildYearButton('6th Sem', '6th'),

                _buildYearButton('7th Sem', '7th'),
                _buildYearButton('8th Sem', '8th'),
              ],
            ),
          ),
          GestureDetector(
